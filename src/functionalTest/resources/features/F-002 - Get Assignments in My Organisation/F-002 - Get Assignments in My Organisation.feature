...
#    And a user [Dil – another solicitor within the same organisation as Richard],
#    And a successful call [to the ‘Assign Access within Organisation’ operation of Case Assignment Microservice assigning Dil access to C1] as in [],
#    And a user [Jamal – another solicitor within the same organisation as Richard],
#    And a successful call [to the ‘Assign Access within Organisation’ operation of Case Assignment Microservice assigning Jamal access to C2] as in [],
#    When a request is prepared with appropriate values,
#    And the request [is made by Richard],
...
#    And a successful call [to the ‘Assign Access within Organisation’ operation of Case Assignment Microservice assigning Mutlu access to C3] as in [],
#    When a request is prepared with appropriate values,
#    And the request [is made by Richard],
