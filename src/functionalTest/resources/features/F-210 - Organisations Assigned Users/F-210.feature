...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: SINGLE CASE: Dry Run, 2 Orgs with assigned users
    ...
    Given an appropriate test context as detailed in the test data source,
      ...
      And a successful call [to assign users to the case but not update OrgCount - 2 users with same role] as in [F-210_Assign_Access_Without_OrgId_C1_Org1_QUK822N],
      And a successful call [to assign users to the case but not update OrgCount - 1 user with 2 roles] as in [F-210_Assign_Access_Without_OrgId_C1_Org2_LESTKK0],
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: SINGLE CASE: No assigned organisations
    ...
    Given an appropriate test context as detailed in the test data source,
      ...
      And a successful call [to set HMCTSServiceId in Supplementary Data for C2] as in [F-210_Supplementary_Data__HMCTSServiceId__C2],
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: SINGLE CASE: Dry Run, 1 GOOD Org with assigned users, 1 BAD org
    ...
    Given an appropriate test context as detailed in the test data source,
      ...
      And a successful call [to set HMCTSServiceId in Supplementary Data for C3] as in [F-210_Supplementary_Data__HMCTSServiceId__C3],
      And a successful call [to remove CREATOR assigned CaseRole for C3] as in [F-210_Delete_Creator_Role_C3],

      And a successful call [to assign users to the case but not update OrgCount - 1 user with 2 roles] as in [F-210_Assign_Access_Without_OrgId_C3_Org2_LESTKK0],
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: SINGLE CASE: Save (but no counts found), 1 Org with no assigned users
    ...
    Given an appropriate test context as detailed in the test data source,
      ...
      And a successful call [to set HMCTSServiceId in Supplementary Data for C4] as in [F-210_Supplementary_Data__HMCTSServiceId__C4],
