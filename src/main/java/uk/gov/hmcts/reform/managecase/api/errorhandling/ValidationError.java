...
public final class ValidationError {
    ...
    public static final String CASE_DATA_EMPTY = "Case Data can not be empty";
    ...
    public static final String CHANGE_ORG_REQUEST_FIELD_MISSING_OR_INVALID = "ChangeOrganisationRequest field could not be found or appears invalid";
