...
public class VerifyNoCAnswersResponse {
    ...
    @Schema(description = "Domain status message", required = true, example = VERIFY_NOC_ANSWERS_MESSAGE)
    private String status;

    @Schema(description = "Organisation for identified case role", required = true)
