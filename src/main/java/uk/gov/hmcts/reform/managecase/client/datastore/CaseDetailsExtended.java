...
import uk.gov.hmcts.reform.managecase.api.payload.AfterSubmitCallbackResponse;
import uk.gov.hmcts.reform.managecase.client.datastore.model.CaseTypeTabField;
import uk.gov.hmcts.reform.managecase.client.datastore.model.SecurityClassification;

import static java.util.Optional.ofNullable;
import static org.apache.http.HttpStatus.SC_OK;
import static uk.gov.hmcts.reform.managecase.client.datastore.model.FieldTypeDefinition.CASE_PAYMENT_HISTORY_VIEWER;
import static uk.gov.hmcts.reform.managecase.client.datastore.model.FieldTypeDefinition.LABEL;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.CASE_REFERENCE;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.CASE_TYPE;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.CREATED_DATE;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.JURISDICTION;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.LAST_MODIFIED_DATE;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.LAST_STATE_MODIFIED_DATE;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.SECURITY_CLASSIFICATION;
import static uk.gov.hmcts.reform.managecase.data.casedetails.search.MetaData.CaseField.STATE;

// partial javadoc attributes added prior to checkstyle implementation in module
@SuppressWarnings("checkstyle:SummaryJavadoc")
public class CaseDetailsExtended implements Cloneable {
    private static final Logger LOG = LoggerFactory.getLogger(CaseDetailsExtended.class);
    ...
    @JsonIgnore
    public CaseDetailsExtended shallowClone() throws CloneNotSupportedException {
        return (CaseDetailsExtended) super.clone();
    }
