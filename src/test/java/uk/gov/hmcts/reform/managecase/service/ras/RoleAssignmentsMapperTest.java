    ...
    class ToRoleAssignments {
        ...
        public void shouldMapToRoleAssignments() {
            ...
            assertAll(
                ...
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getCaseId(),
                    is(roleAssignment2.getAttributes().getCaseId())
                ),
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getJurisdiction(),
                    is(roleAssignment2.getAttributes().getJurisdiction())
                ),
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getCaseType(),
                    is(roleAssignment2.getAttributes().getCaseType())
                ),
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getContractType(),
                    is(roleAssignment2.getAttributes().getContractType())
                ),
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getLocation(),
                    is(roleAssignment2.getAttributes().getLocation())
                ),
                () -> assertThat(
                    roleAssignments.get(1).getAttributes().getRegion(),
